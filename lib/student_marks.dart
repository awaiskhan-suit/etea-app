      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Show details if student fetched
            if (_student != null)
              Expanded(
                child: Row(
            ...
            // PDF download button
            // Save PDF locally button
            ElevatedButton.icon(
              icon: const Icon(Icons.picture_as_pdf),
              label: const Text('Download PDF (With Test Marks)'),
              style: ElevatedButton.styleFrom(
              ...
              onPressed: () async {
                if (_student != null) {
                  await PdfHelper.generateStudentPdfWithMarks(
                    _student!,
                    _student!.rollNo?.toString() ?? '',
                  );
                } else {
